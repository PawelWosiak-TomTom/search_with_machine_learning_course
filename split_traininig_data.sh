...
cat /workspace/datasets/train.txt | cut -d ' ' -f1 | sort | uniq -c | sort -n | head -n5
...
echo "Testing on test: "; ~/fastText-0.9.2/fasttext test /workspace/datasets/model.bin /workspace/datasets/test.txt